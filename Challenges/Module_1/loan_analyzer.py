...
average_loan_amount = total_of_loans / total_number_of_loans
...
fair_price = future_value / (1 + discount_rate / 12) * remaining_months
print(fair_price)
...
annual_discount_rate = 0.01 / 5 * 100
